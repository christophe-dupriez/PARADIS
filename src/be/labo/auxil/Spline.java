 ...
 * Modified for integration in Akuino... (double instead of float + caching of results)
 *
...
public final class Spline {
	...
	public static ConcurrentHashMap<Integer,Spline> scalingSpline = new ConcurrentHashMap<Integer,Spline>();
