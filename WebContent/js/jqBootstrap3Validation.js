/* jqBootstrapValidation MODIFIED for BootStrap 3
...
(function( $ ){
    ...
    methods: {
      init : function( options ) {
        ...
        $(uniqueForms).bind("submit", function (e) {
          var $form = $(this);
          var warningsFound = 0;
          var $inputs = $form.find("input,textarea,select").not("[type=submit],[type=image],[type=hidden]").filter(settings.options.filter);
  ...
  **/
  ...
  $.jqBootstrapValidation = function (options) {
    $(":input").not("[type=image],[type=submit],[type=hidden]").jqBootstrapValidation.apply(this,arguments);
  };
