<div id='colorPicker'>
	<span id='divpreview' style='height:30px;width:100px;border:1px solid #d4d4d4;border-bottom:none;background-color:${colorHex}'> &nbsp; &nbsp; &nbsp; &nbsp; </span>
	<span id='divpreviewtxt' style='width:50px;padding-left:5px;padding-top:7px;'>${colorHex}</span>
<div style="position:relative;"><%--
--%><img style='margin-right:2px;' src='colormap.gif' usemap='#colormap' alt='colormap' /><div id='selectedColor' style='position:absolute;width:21px;height:21px;top:0px;left:0px;background-image:url("selectedcolor.gif")'></div><%--
...
<script>
	var divSelectedColor = document.getElementById("selectedColor");
	divSelectedColor.style.top = "0px";
	divSelectedColor.style.left = "0px";
	divSelectedColor.style.display = "none";
	...
	function clickColor(hex, seltop, selleft) {
		...
		//alert('CLICK='+colorhex);
		$('#' + colorhexId).val(colorhex);
		if (seltop > -1 && selleft > -1) {
			divSelectedColor.style.top= (seltop - 21)+'px';
			divSelectedColor.style.left= selleft+'px';
			divSelectedColor.style.display = "inline";
		} else {
			document.getElementById("divpreview").style.backgroundColor = colorhex;
			document.getElementById("divpreviewtxt").innerHTML = colorhex;
			divSelectedColor.style.display = "none";
